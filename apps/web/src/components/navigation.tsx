...
export function ProjectNav({ projectId }: NavProps) {
  ...
  const navItems = [
    ...
    { label: t('nav.ai_images'), path: `/project/${projectId}/ai-image` },
    { label: t('nav.ai_video'), path: `/project/${projectId}/ai-video` },
    { label: t('nav.social'), path: `/project/${projectId}/social-accounts` },
